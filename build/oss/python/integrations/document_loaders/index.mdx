...
| [PyMuPDF Layout](/oss/python/integrations/document_loaders/pymupdf-layout) | Load PDF content to Markdown using AI-based, CPU only, PyMuPDF Layout analysis | Package |
